...
const file_flowdeploy_v1_server_proto_rawDesc = "" +
	...
	"\x12enable_auto_update\x18\x05 \x01(\bR\x10enableAutoUpdate\"\x92\x03\n" +
	...
	"\fupdate_error\x18\a \x01(\tH\x01R\vupdateError\x88\x01\x01B\n" +
	"\n" +
	"\b_metricsB\x0f\n" +
	"\r_update_error\"\xf9\x01\n" +
	"\vAgentStatus\x12/\n" +
	...
	"\x05ports\x18\b \x03(\v2\x1a.flowdeploy.v1.PortBindingR\x05ports\x12\x1a\n" +
	"\bnetworks\x18\t \x03(\tR\bnetworks\x125\n" +
	"\x06mounts\x18\n" +
	" \x03(\v2\x1d.flowdeploy.v1.ContainerMountR\x06mounts\x1a9\n" +
	...
	"\tread_only\x18\x04 \x01(\bR\breadOnly\"\xc6\x01\n" +
	...
	"\x06images\x18\x01 \x03(\v2\x18.flowdeploy.v1.ImageInfoR\x06images\"\xb7\x01\n" +
	"\tImageInfo\x12\x0e\n" +
	...
	"\bdangling\x18\x06 \x01(\bR\bdangling\x12\x1e\n" +
	"\n" +
	...
	"\binternal\x18\x05 \x01(\bR\binternal\"*\n" +
	...
	"\avolumes\x18\x01 \x03(\v2\x19.flowdeploy.v1.VolumeInfoR\avolumes\"X\n" +
	"\n" +
	"VolumeInfo\x12\x12\n" +
	...
	"\tExecInput\x127\n" +
	"\x05start\x18\x01 \x01(\v2\x1f.flowdeploy.v1.ExecStartRequestH\x00R\x05start\x12\x14\n" +
	"\x04data\x18\x02 \x01(\fH\x00R\x04data\x123\n" +
	"\x06resize\x18\x03 \x01(\v2\x19.flowdeploy.v1.ExecResizeH\x00R\x06resizeB\t\n" +
	"\apayload\"s\n" +
	"\x10ExecStartRequest\x12!\n" +
	"\fcontainer_id\x18\x01 \x01(\tR\vcontainerId\x12\x14\n" +
	...
	"\x17GetCertificatesResponse\x12B\n" +
	"\fcertificates\x18\x01 \x03(\v2\x1e.flowdeploy.v1.CertificateInfoR\fcertificates\"\x18\n" +
	"\x16PruneContainersRequest\"|\n" +
	"\x17PruneContainersResponse\x12-\n" +
	"\x12containers_removed\x18\x01 \x01(\x05R\x11containersRemoved\x122\n" +
	"\x15space_reclaimed_bytes\x18\x02 \x01(\x03R\x13spaceReclaimedBytes\"\x15\n" +
	"\x13PruneVolumesRequest\"s\n" +
	"\x14PruneVolumesResponse\x12'\n" +
	"\x0fvolumes_removed\x18\x01 \x01(\x05R\x0evolumesRemoved\x122\n" +
	"\x15space_reclaimed_bytes\x18\x02 \x01(\x03R\x13spaceReclaimedBytes*\x8b\x01\n" +
	"\n" +
	"AgentState\x12\x1b\n" +
...
var file_flowdeploy_v1_server_proto_msgTypes = make([]protoimpl.MessageInfo, 65)
var file_flowdeploy_v1_server_proto_goTypes = []any{
	...
	nil,                              // 65: flowdeploy.v1.ContainerInfo.LabelsEntry
	nil,                              // 66: flowdeploy.v1.UpdateDomainsRequest.EnvVarsEntry
	(*timestamppb.Timestamp)(nil),    // 67: google.protobuf.Timestamp
	(DeployStage)(0),                 // 68: flowdeploy.v1.DeployStage
}
var file_flowdeploy_v1_server_proto_depIdxs = []int32{
	...
	67, // 3: flowdeploy.v1.HeartbeatRequest.timestamp:type_name -> google.protobuf.Timestamp
	...
	67, // 8: flowdeploy.v1.AgentStatus.started_at:type_name -> google.protobuf.Timestamp
	68, // 9: flowdeploy.v1.ActiveDeployment.stage:type_name -> flowdeploy.v1.DeployStage
	67, // 10: flowdeploy.v1.ActiveDeployment.started_at:type_name -> google.protobuf.Timestamp
	...
	67, // 15: flowdeploy.v1.ContainerInfo.created_at:type_name -> google.protobuf.Timestamp
	65, // 16: flowdeploy.v1.ContainerInfo.labels:type_name -> flowdeploy.v1.ContainerInfo.LabelsEntry
	...
	67, // 19: flowdeploy.v1.ContainerLogsRequest.since:type_name -> google.protobuf.Timestamp
	67, // 20: flowdeploy.v1.ContainerLogEntry.timestamp:type_name -> google.protobuf.Timestamp
	67, // 21: flowdeploy.v1.ContainerStats.timestamp:type_name -> google.protobuf.Timestamp
	...
	66, // 26: flowdeploy.v1.UpdateDomainsRequest.env_vars:type_name -> flowdeploy.v1.UpdateDomainsRequest.EnvVarsEntry
